<template>
  ...
  <div class="personal">
    ...
    <el-descriptions title="User Info" width=220px>
      <el-descriptions-item label="Username" width=220px>{{ personalInfo.username }}</el-descriptions-item>
      <el-descriptions-item label="Telephone" width=260px>{{ personalInfo.phone }}</el-descriptions-item>
      <el-descriptions-item label="Place">{{ personalInfo.location }}</el-descriptions-item>
      <el-descriptions-item label="Remarks">
        <el-tag size="small">帅气</el-tag>
      </el-descriptions-item>
      <el-descriptions-item label="Introduction"
      >{{ personalInfo.introduction }}</el-descriptions-item
      >
    </el-descriptions>
