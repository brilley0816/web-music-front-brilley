...
<!--    </div>-->
    ...
    <!--设置-->
<!--    //如果token为零，没有登陆，显示登陆和注册-->
    <yin-header-nav class="yin-header-nav" v-if="!token" :styleList="signList" :activeName="activeNavName" @click="goPage"></yin-header-nav>

<!--    //如果token不为零，已经登陆，头像有下拉框选项-->
